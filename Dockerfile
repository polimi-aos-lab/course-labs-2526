...
RUN wget https://github.com/mirror/busybox/archive/refs/tags/1_32_1.tar.gz -O busybox-1.32.1.tar.gz
RUN tar xvzf busybox-1.32.1.tar.gz
RUN mv busybox-1_32_1 busybox-1.32.1
